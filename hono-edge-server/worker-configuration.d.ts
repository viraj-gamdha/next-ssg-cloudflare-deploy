/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b956440e2e97feccdafbf6c334b05881)
// Runtime types generated with workerd@1.20250604.0 2025-06-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		GITHUB_REPO: "static-built-website";
		GITHUB_OWNER: "viraj-gamdha";
		GITHUB_TOKEN: "WfEwxGXadCI1ZNlVrFqGBycvE1j1DiG4EngMM1T9";
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_REPO" | "GITHUB_OWNER" | "GITHUB_TOKEN">> {}
}
